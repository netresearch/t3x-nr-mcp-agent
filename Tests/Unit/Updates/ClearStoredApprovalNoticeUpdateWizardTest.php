 ...
 * native on v13, a deprecated subclass of the core attribute on v14 (shipped
 * under cms-core/DeprecatedClasses, tagged by Symfony's attribute
 * autoconfiguration through its parent class). The registry has a different
 * class on each core and no deprecated counterpart, so it cannot be asked
 * here.
 *
